    ...
    public sealed partial class HubPage : Page
    {
        ...
        private void checkForFirstRun()
        {
            if (!ApplicationData.Current.RoamingSettings.Values.ContainsKey("FirstRunV4006"))
            {
                ...
                ApplicationData.Current.RoamingSettings.Values["FirstRunV4006"] = true;
            }
        }
