    ...
    public sealed partial class HubPage : Page
    {
        ...
        private void checkForFirstRun()
        {
            if (!ApplicationData.Current.RoamingSettings.Values.ContainsKey("FirstRunV4002"))
            {
                ...
                ApplicationData.Current.RoamingSettings.Values["FirstRunV4002"] = true;
            }
        }
